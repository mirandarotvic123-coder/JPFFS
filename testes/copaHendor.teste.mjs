...
const sp = C.substitutosPossiveis(c3, C.partidaPorId(c3, "q1"), jog, (id) => pos3[id]);
eq(sp.daFaseAnterior, ["hendor", "daniel", "samuel", "gueno"], "da fase anterior: sem devendo, na ordem da classificação");
